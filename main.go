...
func main() {
	...
	countTextPtr := countCommand.String("text", "", "Text to parse, (require).")
	countMetricPtr := countCommand.String("metric", "chars",
		"Metric {chars|words|lines|substring}. (Required)")
	countSubstringPtr := countCommand.String("substring", "",
		"The substring to be counted. Required for --metric=substring")
